  ...
  return (
    <div className="g" style={css('border-radius:16px;padding:14px 16px;display:flex;align-items:center;gap:14px')}>
      ...
      <div style={css('flex:1;position:relative;z-index:2')}>
        ...
        <div style={css('font-size:12px;color:rgba(240,236,230,.45);display:flex;align-items:center;gap:8px')}>{tag}{location}</div>
      </div>
      <div style={css('font-size:11px;color:rgba(240,236,230,.35);position:relative;z-index:2;flex-shrink:0')}>{date}</div>
    </div>
  );
}
