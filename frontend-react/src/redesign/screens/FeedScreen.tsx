...
/** SCREEN: FIL D'ACTIVITÉ — port fidèle (proto l.561-653). */
  ...
  return (
    <div className={cn('sc', active === 'fil' && 'active')} id="sc-fil">
      ...
      <div style={css('padding:16px 20px;display:flex;gap:12px;overflow-x:auto;scrollbar-width:none')}>
        <StoryItem circleStyle="background:rgba(255,255,255,.06);border:2px dashed rgba(255,255,255,.15);color:rgba(240,236,230,.4)" label="Ajouter" labelColor="rgba(240,236,230,.4)">+</StoryItem>
          ...
          <div style={css('position:relative;z-index:2')}>
            <div style={css('padding:16px 16px 12px;display:flex;align-items:center;gap:10px')}>
              ...
              <div style={css('flex:1')}>
                ...
                <div style={css('font-size:11px;color:rgba(240,236,230,.40)')}>il y a 2h · Gorges du Verdon</div>
              </div>
              <div style={css('font-size:11px;color:rgba(240,236,230,.30)')}>···</div>
            </div>
            <div style={css('padding:0 16px 14px')}>
              <div style={css('display:flex;align-items:center;gap:8px;margin-bottom:8px')}>
                ...
                <div>
                  ...
                  <div style={css('font-size:12px;color:rgba(240,236,230,.45)')}>Redpoint · 3ème essai</div>
                </div>
          ...
          <div style={css('position:relative;z-index:2')}>
            <div style={css('padding:16px 16px 12px;display:flex;align-items:center;gap:10px')}>
              ...
              <div style={css('flex:1')}>
                ...
                <div style={css('font-size:11px;color:rgba(240,236,230,.40)')}>il y a 5h · Chamonix</div>
              </div>
            </div>
            <div style={css('padding:0 16px 14px')}>
          ...
          <div style={css('position:relative;z-index:2')}>
            <div style={css('padding:16px 16px 12px;display:flex;align-items:center;gap:10px')}>
              ...
              <div style={css('flex:1')}>
                ...
                <div style={css('font-size:11px;color:rgba(240,236,230,.40)')}>hier · Fontainebleau</div>
              </div>
            </div>
            <div style={css('padding:0 16px 14px')}>
              <div style={css('display:flex;align-items:center;gap:8px;margin-bottom:8px')}>
                ...
                <div>
                  ...
                  <div style={css('font-size:12px;color:rgba(240,236,230,.45)')}>Flash · Bloc</div>
                </div>
